    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gif', models.FileField(blank=True, null=True, upload_to='media/gif', verbose_name='Gif игрока')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.club', verbose_name='Гости')),
                ('home', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='home', to='core.club', verbose_name='Хозяева')),
            ],
            options={
                'verbose_name': 'Матч',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='details', to='core.matches')),
            ],
            options={
